...
<html lang="en">
  <head>
	...
	<body class="img js-fullheight" style="background-image: url(images/kadugede.jpg);">
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section"><u>Form Register APMK</u></h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
				  ...
				  <div class="form-group">
                    ...
                    <div class="form-group">
					  ...
					  <div class="form-group">
		      			<input name="txtTelp" type="text" class="form-control" placeholder="Telphone" required>
                  </div>
	                <div class="form-group">
