...
class Laporan extends BaseController
{
	...
	public function pengaduanTampil(){
		...
		$htmlData .='<thead class="bg-secondary">
						<tr>
						<th>No</th>
						<th>Nik</th>
						<th>Nama</th>
		...
		<a href="/laporan/download-pdf/' . $this->request->getPost('txtTglPengaduan') . ' class="btn btn-info btn-sm mr-2"> </a>
		<button href="/print" onclick="window.print()" class="btn btn-danger btn-sm mr-2"<i class="fa fa-print"></i>Print</button>
		</p>';	
		echo $htmlData;	 
